...
* Also think about "action at a distance": most analytics software thinks about a referrer as the page you were on that led you to our site. But what if someone visited your site by clicking on an ad, then google some information about your product, go back to your site and buy it. The ad is what led to that purchase, but if you track direct referrers instead of first referrers, you wouldn't know that.
...
Think about presentation as well: do you care about the raw number, do you care about increase/decrease, do you care about a number as a percentage of another number? (How many loyal visitors you have is important, but one that's prone to go up and down because of factors outside of your influence -- a more stable and actionable metric is what percentage of your visitors you'd consider as loyal, and then separately, how many visitors you have. Otherwise you're conflating two different measures into one, and that may sound like a good idea -- one less number to track -- but it's not)