...
Take a look at your website's page load times and compare with how many pages a user will browse through before calling it quits. Strong inverse correlation? People browse more if the site is snappier for them? Then your site is too slow. Metrics help you find problems.
...
Have you noticed how readers who come in through social media don't often stick around? Those could be loyal visitors. Metrics help you see opportunities.
...
But the thing is, too many people in the news industry when they open their Google Analytics dashboard aren't looking for opportunities, they wouldn't see problems if they were right in front of them and they sure won't let a bunch of bloody numbers decide what to prioritize.

The news industry needs to grow up when it comes to how we deal with metrics. Either we obsess about pageviews or we pick another metric we like more, time on site, say, and we decide that, from now on, that's really what it's all about. Or we get all fancy and "gather a whole basket of numbers":http://www.niemanlab.org/2010/10/getting-beyond-just-pageviews-philly-coms-seven-part-equation-for-measuring-online-engagement/ to gape at. Metrics don't work like that.
...
Or maybe you have no clue what to work on and what you really should do is line up ten different hypotheses for how you can do better for your readers, and figure out the metrics or experiments that will tell you whether or not any of those hypotheses make sense. Why did you decide to do that redesign in the first place?

Use data to help you decide on your goals and use goals to decide what data you need. Never measure because you can. Measure to learn. Measure to fix.
